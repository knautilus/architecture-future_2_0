...
| Dremio               | Платформа анализа данных, позволяющая запрашивать данные из разных источников с помощью стандартного SQL | Быстрое формирование отчётности |
...
| Портал самообслуживания | Q2-Q4 2026 | Миграция данных в Data Lakehouse, внедрение Airflow. Разработка портала, использование IAM, Power BI, Dremio, тестирование. | BI, Frontend, Backend | Ресурсы на разработку, IAM, Power BI, Dremio |
...
| AI-интеграции и аналитика | Q4 2026 | Подключение AI к медицинским данным, настройка ИИ моделей | Команда Data Science и AI | GPU |
