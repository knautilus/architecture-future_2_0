...
| ---------------------------------- |------------|-----------------------------------------------------------------| ------------------------- | ---------------------- |
| Подготовка инфраструктуры          | Q1–Q2 2026 | Внедрение Kubernetes, CI/CD, централизованной авторизации (IAM) | DevOps Team               | Облако, лицензии CI/CD |
...
| AI-интеграции и аналитика          | Q4 2026    | Внедрение MLflow и Airflow, подключение AI к медицинским данным | Команда Data Science и AI | GPU, Vertex AI         |
| Интеграция с внешними партнёрами   | Q1 2026    | Интеграция с партнерами (фармацевтика и электроника) через API  | Backend                   | API Gateway, SDK       |
...
| Масштабирование и внешние партнёры | Открыть новые источники дохода                         | Расширение экосистемы компании             | Расширение экосистемы, интеграция внешних API                        |
